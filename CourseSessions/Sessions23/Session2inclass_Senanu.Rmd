...
##### Answers:
<p>1. There are higher correlations for answers to questions with similar themes - price, type of boat, features, etc.</p>
<p>2. The correlations imply that within these 29 questions, there are a set of factors that resonate with similar groups of people who buy boats.</p>
<br>
<br>
...
**Your Answers here:**
<p> Question 1: The table shows the main factors(components) and how much of the total data this factor explains. The higher the factor's Eigen Value, the more that factor weighs in the data interpretation.</p>
<p> Question 2: The plot is shaped because it is cummulative, plotting the highest ranked eigen values first.
<p> Question 3: The most important characteristics will be more preferred to see as it simplifies description of the multiple questions.</p>
...
**Your Answers here:**
<br> 1. These are the most important factors and consumer preferences and attitudes towards it. They make business set as they form the basis for market and customer segmentation
<br>2. 5 factors - based on 1. the eigen values 2. each of the factors is unique on its own and 3. from a business perspective, we can drive different marketing approaches based on these 5 factors.
<br>3. 
<Factor 1 </p> Status symbol
<Factor 2 </p> Outdoory and adventurous
<Factor 3 </p> Brand and reputation
<Factor 4 </p> Boating enthusiast
<Factor 5</p> Price conscious
...
**Your Answers here:**
<br> 1. Three (3) segments. The dendogram suggests 3 unique segments
<br>2. Segment 1: Unenthusiastic social boaters; Segment 2: Future boat purchasers; Segment 3: Boat enthusiasts with strong prestige associations.
<br>3. Changing the number of segments either develops smaller segments for micro-segmenting and targeting purposes or larger segments if the segments are reduced.
<br>4. Strategy: Firm should market to segment 3 and base their strategy on the technological attributes and derivation of social status. Since the segment is price sensitive, she should focus on quality since this is important to the segment.
